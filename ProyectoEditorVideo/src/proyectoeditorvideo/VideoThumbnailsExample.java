...
public class VideoThumbnailsExample {
    ...
    public static void agregarImagen(String inputVideo,String pathOutput, String imagePath) {
            ...
            if(event.getMediaData().isComplete())
            {
            	...
            	try {
    	        	...
    	        	for(int i = 0; i < image.getWidth(); i++)
    	        	{
    	        		...
    	        		{
    	        			if( j < insertImage.getHeight() && i < insertImage.getWidth())
    	        			{
    	        				int rgb = insertImage.getRGB(i, j);
